...
contract(
  'FantomMarketplace - Collection Royalty Test',
  function ([owner, platformFeeRecipient, artist, feeRecipient]) {
    ...
    it('should register a collection royalty [1% (100)]', async function () {
    ...
    it('should update a collection royalty [1% -> 5%]', async function () {
      await this.fantomMarketplace.registerCollectionRoyalty(
        this.mockERC721.address,
        artist,
        new BN('500'),
    ...
    it('should not register a collection royalty if not an owner', async function () {
      await expectRevert(
    ...
    it('should not register a collection royalty if creator address is 0', async function () {
      await expectRevert(
        this.fantomMarketplace.registerCollectionRoyalty(
          this.mockERC721.address,
    ...
    it('should not register a collection royalty if fee recipient address is 0', async function () {
      await expectRevert(
        this.fantomMarketplace.registerCollectionRoyalty(
          this.mockERC721.address,
          artist,
    ...
    it('should fail to register a collection royalty [101% (10001)]', async function () {
      await expectRevert(
        this.fantomMarketplace.registerCollectionRoyalty(
          this.mockERC721.address,
          artist,
    ...
    it('should fail to register a collection royalty if collection exists in Factory', async function () {
