...
Contract: FantomAuction
    √ 000) `MockERC20` tokens minted to users properly (107ms)
    √ 001) `MockERC20` `approve` set to `FantomAuction` for all test users (133ms)
    √ 002) `MockERC721` tokens minted to users properly (167ms)
    √ 003) `MockERC721` `setApprovalForAll` set to `FantomAuction` for all test users (104ms)
    ...
    √ 007) test auction created successfully for user `seller` (41ms)
    ...
    √ 030) bid successfully placed at `minBidIncrement` (38ms)
    ...
    √ 038) successfully relisted auction for `seller` `_tokenId(4)` after cancelling auction with bids
    √ blockchain time increased 50 seconds
    √ blockchain time increased 50 seconds
    √ 039) NFT successfully in escrow with auction contract after relisting by `seller`
    √ 040) bid successfully placed at `minBidIncrement` by `bidder` (49ms)
    ...
    √ 053) successfully cancelled auction that ended with bids below reserve price as `seller` (43ms)
    ...
    √ 056) successfully relisted auction for `seller` `_tokenId(4)` after cancelling ended auction with bids (39ms)
    √ blockchain time increased 50 seconds
    √ blockchain time increased 50 seconds
    ...
    √ 079) all users and auction contract have the correct amount of MockERC20 tokens after a successful auction (38ms)
    √ 080) successfully listed auction for `seller` `_tokenId(3)` (53ms)
    √ blockchain time increased 50 seconds
    √ blockchain time increased 50 seconds
    ...
    √ 083) bid successfully placed at `sellerReservePrice` by `winner` (45ms)
    √ blockchain time increased 500 seconds
    √ blockchain time increased 500 seconds
